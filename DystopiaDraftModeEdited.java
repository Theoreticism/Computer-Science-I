...
/*      case 6: //seventh case is golem
  ...
  public static int damageAndCrit(String symbol) {
    if (symbol == "goblin") {
      ...
      if ((crit > 0)&&(crit <= 5)) {
        System.out.println("Time seems to slow down. The "+symbol+"'s hands pulse with dark power as it sees an opening in your defenses...");
        return (temp*2);
      } else {
        return temp;
      }
  ...
  public static int intelligenceShardSprayModifier(int intel4) {
    if (intel4 == 1) {
      return ((int)(Math.random()*4+7));
    } else if (intel4 == 2) {
      return ((int)(Math.random()*7+7));
    } else if (intel4 == 3) {
      return ((int)(Math.random()*7+10));
    } else if (intel4 == 4) {
      return ((int)(Math.random()*10+10));
    } else if (intel4 == 5) {
      return ((int)(Math.random()*10+13));
    } else if (intel4 == 6) {
      return ((int)(Math.random()*13+13));
    } else if (intel4 == 7) {
      return ((int)(Math.random()*13+16));
    } else if (intel4 == 8) {
      return ((int)(Math.random()*16+16));
    } else if (intel4 == 9) {
      return ((int)(Math.random()*16+19));
    } else {
      return ((int)(Math.random()*19+19));
    }
